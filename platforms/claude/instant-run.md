...
Support SAFE RUN, FAST RUN, ECOMMERCE, SOCIAL, BOTH, CONTINUE, NEXT PRODUCT, REPAIR PRODUCT, REPAIR COLOR, REPAIR DETAILS, REPAIR EDGES, REPAIR BACKGROUND, REPAIR LIGHTING, REPAIR COMPOSITION, and START OVER FROM SOURCE. NEXT PRODUCT clears the previous source and lock while retaining the Reference Style Profile and other batch settings.
