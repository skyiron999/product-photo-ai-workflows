...
5. Thêm đúng bốn file đã gom sau vào Project Knowledge:
...
Khi repo thay đổi, tải lại bundle tương ứng trong Project Knowledge. Nếu `installed-instructions.md` đổi, thay lại Project Instructions. Kiểm tra capability và chạy thử một case trước khi dùng cho batch thật.
