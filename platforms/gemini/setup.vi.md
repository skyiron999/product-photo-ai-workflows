...
5. Trong phần **Knowledge**, thêm:
   - các tài liệu trong `core/`;
   - module trong `products/`;
...
Khi module hoặc instructions trong repo thay đổi, thay file tương ứng trong Knowledge và lưu lại Gem. Test lại một sản phẩm trước khi dùng cho batch tiếp theo.
